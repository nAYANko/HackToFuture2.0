...
key = RSA.generate(4096, e=444714424449627621911950339159)
...
for i in range(len(cipher_text)):
    encrp_data =list(cipher.encrypt(cipher_text.encode("utf-8")))
print (encrp_data)
#for x in range(encrp_data):
    #print(encrp_data[x])